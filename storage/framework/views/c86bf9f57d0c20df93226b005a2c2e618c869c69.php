  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <?php echo $__env->make('backend.admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- / Menu -->

        <!-- Layout container -->
        <div class="layout-page">
          <!-- Navbar -->
          <?php echo $__env->make('backend.admin.layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          <!-- / Navbar -->
          ...
          <div class="content-wrapper">
            ...
            <!-- Footer -->
            <?php echo $__env->make('backend.admin.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- / Footer -->
          </div>
          <!-- Content wrapper -->
        </div>
            ...
            $(document).on("click", "#edit_id", function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('input[type="radio"]').filter('[value=' + response.Userdata.gender +']').prop("checked", true);
                        var image = "<img src='<?php echo e(asset('image/')); ?>/" + response.Userdata
                            .image +
                        ...
                        if (response.Userdata.role == "Admin") {
                            ...
                            var html ='<option value="" selected disabled>Select Role_Type </option>';
...
<?php /**PATH C:\wamp64\www\Admin_panal\resources\views/backend/admin/layouts/index.blade.php ENDPATH**/ ?>